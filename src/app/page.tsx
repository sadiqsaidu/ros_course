...
export default function HomePage() {
  const lectures: LectureCardProps[] = [
    ...
    },
    {
      ...
      description: 'Multiple subscribers, filtering sensor data, and aggregating information.',
      status: 'completed',
      topics: ['Filters', 'Aggregators', 'Pipelines', 'Multi-Subscriber'],
      href: '/lectures/3',
    },
    {
      number: 4,
      title: 'Services',
      description: 'Request-response communication for one-time queries and commands.',
      status: 'completed',
      topics: ['Services', 'Clients', 'Servers', 'Request-Response'],
      href: '/lectures/4',
    },
    {
      number: 5,
